<nav class="bg-blue-100 border-b fixed z-20 top-0 start-0 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="min-w-screen flex flex-wrap items-center justify-between mx-auto p-4 gap-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-blue-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
